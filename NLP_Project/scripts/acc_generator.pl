...
my $trainDataPath = "../train/ngram/";
my $testDataPath = "../test/ngram/"; 
...
for(my $i = 1; $i <= $noOfBots; $i++ )
{
	...
	{
		system($trainPath . " " . $trainDataPath . $n . "." . $i . "_" . $j . ".trn mymodel");
		system($predictPath . " " . $testDataPath . $n . "." . $i . "_" . $j . ".tst mymodel output >> temp");
		system($predictPath . " " . $testDataPath . $n . "." . $j . "_" . $i . ".tst mymodel output >> temp");					
	}
}
